        ...
        for symbol in self.symbols:
            ...
            for i in range(100, len(df_ltf) - 50):
                ...
                if setup and setup.get('setup_exists'):
                    ...
                    pnl = risk * rr if outcome == 'win' else -risk
                    self.balance += pnl
                    ...
                    tid = self.agent.memory.log_trade(symbol, "LTF", setup['direction'], setup.get('reasoning', ''), setup['entry_price'], setup['sl'], setup['take_profit'], outcome.upper(), rr, "", str(current_time))
