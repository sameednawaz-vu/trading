...
class DataIngestor:
    ...
    def fetch_historical_data(self, symbol, start_date_str, end_date_str):
        """Fetches a full year of historical data in 1m chunks and resamples it."""
        timeframe = '1m'
        ...
        resampled_dfs = {}
        # Kraken might not have 3m, resample from 1m
        timeframes_to_resample = {'3m': '3min', '5m': '5min', '15m': '15min', '30m': '30min', '1h': '1h'}

        for tf, freq in timeframes_to_resample.items():
            ...
            filename = f"{symbol.replace('/', '_')}_{tf}_full.csv"
